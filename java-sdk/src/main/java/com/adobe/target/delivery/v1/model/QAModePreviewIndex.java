...
public class QAModePreviewIndex {
  ...
  /**
   * Index references the activity in the activity list (from the encrypted token). Validation * If
   * the activity list index is out of boundaries of the activities list in the token or if it is
   * null it will be ignored. * Activity list index starts with 1. * Should be at least one activity
   * index, and should reference an activity specified in the token. minimum: 1
   *
   ...
   * Validation * Can be null (unspecified) * If index is not specified or out of bounds, the
   * experience will be selected via activity experience selector strategy. * Experience index
   * starts with 1. minimum: 1
   *
