...
public class NotificationDeliveryService {
        ...
        new ThreadPoolExecutor(
            ...
            (r, executor) -> {
              RejectedExecutionException e =
                  new RejectedExecutionException("On-device-decisioning notification queue full");
              TargetExceptionHandler handler = clientConfig.getExceptionHandler();
              if (handler != null) {
                handler.handleException(
                    new TargetClientException("On-device-decisioning notification rejected", e));
              }
              throw e;
            });
  }
  ...
  public void stop() {
    try {
      ...
      logger.info(
          "Caught InterruptedException while shutting down NotificationDeliveryService: " + e);
    }
  }
}
