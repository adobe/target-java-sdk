...
public class Action {
  ...
  private ActionContentOneOf content = null;
  ...
  public Action content(ActionContentOneOf content) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public ActionContentOneOf getContent() {
    return content;
  }

  public void setContent(ActionContentOneOf content) {
    this.content = content;
  }
