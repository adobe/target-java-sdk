...
public class Option {
  ...
  private OptionContentOneOf content = null;
  ...
  public Option content(OptionContentOneOf content) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public OptionContentOneOf getContent() {
    return content;
  }

  public void setContent(OptionContentOneOf content) {
    this.content = content;
  }
  ...
  public Option putResponseTokensItem(String key, Object responseTokensItem) {
    if (this.responseTokens == null) {
      this.responseTokens = new HashMap<String, Object>();
    }
