...
public class DefaultTargetClient implements TargetClient {
  ...
  @Override
  public CompletableFuture<Attributes> getAttributesAsync(
      TargetDeliveryRequest targetRequest, String... mboxes) {
    CompletableFuture<TargetDeliveryResponse> completableResponse =
        getOffersAsync(addMBoxesToRequest(targetRequest, mboxes));
  ...
  private static TargetDeliveryRequest addMBoxesToRequest(
      TargetDeliveryRequest targetRequest, String... mboxes) {
