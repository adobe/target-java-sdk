...
class TargetDeliveryRequestLocalViewTest {
  ...
  static final class SelectorContent {
    ...
    public SelectorContent(
        String type, String selector, String cssSelector, Object content, String eventToken) {
      this.type = type;
  ...
  void testTargetDeliveryLocalNamedViews() throws IOException, NoSuchFieldException {
    ...
    List<SelectorContent> contactSelectors =
    ...
    List<SelectorContent> homeSelectors =
        new ArrayList<SelectorContent>() {
          {
            add(
                new SelectorContent(
  ...
  private TargetDeliveryRequest localDeliveryRequest(
      String visitorIdStr, List<String> views, boolean execute) {
    ...
    TargetDeliveryRequestBuilder targetDeliveryRequestBuilder =
