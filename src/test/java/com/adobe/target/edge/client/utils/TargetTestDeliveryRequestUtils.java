...
public class TargetTestDeliveryRequestUtils {
  ...
  public static List<TargetCookie> getTestCookies() {
    ...
    String visitorValue =
        "-1330315163%7CMCIDTS%7C18145%7CMCMID%7C"
            + TargetDeliveryRequestTest.TEST_MCID
    ...
    try {
      visitorCookie =
          new TargetCookie(
              "AMCV_" + URLEncoder.encode(TEST_ORG_ID, "UTF-8"),
              visitorValue,
              timeNow + SESSION_ID_COOKIE_MAX_AGE);
  ...
  public static List<TargetCookie> getExpiredSessionCookie() {
    ...
    String cookieValue =
        "session#430a140336d545daacde53af9636eef5#"
  ...
  public static List<Notification> getMboxNotifications() {
    ...
    for (PrefetchMboxResponse mbox : dummyMboxPrefetchResponse) {
      NotificationMbox notificationMbox =
          new NotificationMbox().name(mbox.getName()).state(mbox.getState());
  ...
  static void setNotificationOptions(
      List<Notification> notifications, Notification notification, List<Option> options) {
  ...
  public static void fileRuleLoader(String fileName, OnDeviceDecisioningService localService)
    ...
    FieldSetter.setField(
        localService, localService.getClass().getDeclaredField("ruleLoader"), testRuleLoader);
    FieldSetter.setField(
        localService,
        localService.getClass().getDeclaredField("onDeviceDecisioningEvaluator"),
        evaluator);
  }
}
